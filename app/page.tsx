  ...
  return (
    ...
    <div className=" overflow-x-hidden">
      <div className="h-[100%] max-md:w-100 max-md:h-[100%] max-lg:static  relative  bg-center container  bg-cover bg-gray-50/50 bg-blend-overlay px-16 py-4 max-md:flex max-md:flex-col max-md:px-0 bg-no-repeat w-[100vw]   ">
        ...
        <div className="mt-6 max-md:text-center flex  items-center  justify-center flex-col max-lg:w-[100vw] ">
          <p className="text-[5rem] max-md:text-[2.4rem] font-semibold">Revolutionize your</p>
      ...
      <div className=" p-20 max-md:p-0 max-lg:p-0 max-lg:w-[100vw] max-lg:flex-wrap ">
        ...
        <div className="  px-10 flex pt-10 justify-between items-center w-[100%] max-md:p-10 gap-3 max-md:flex-wrap  ">
          ...
          <div className="bg-gradient-to-br w-[100%] h-fit justify-center flex flex-col from-sky-100 to-blue-100  rounded-2xl p-6">
            <div className="flex items-center flex-col space-x-4 p-10">
              <div className="p-3 bg-[url(../public/first.png)] size-81 max-md:size-61 bg-center bg-contain bg-no-repeat   ">
               
              </div>
            </div>
            <div className="mt-3 text-2xl font-medium  pb-3 text-shadow-gray-900 text-input ">AI-Generated quiz</div>
            <p className="font-normal text-gray-900 w-[90%]">Done revising? The test begins instantly – let’s see what you’ve got!"</p>
          </div>
          <div className="bg-gradient-to-br w-[100%] h-fit justify-center flex flex-col from-emerald-100 to-green-100  rounded-2xl p-6">
            <div className="flex items-center justify-center flex-col space-x-4 p-10">
              <div className=" rounded-full bg-[url(../public/reminder.jpg)] size-82 max-md:size-61 bg-cover bg-no-repeat bg-center   ">
        ...
        <div className=" max-lg:px-10 w-[100%] max-md:flex-wrap px-10 flex pt-2 justify-between  items-center  gap-3 ">
          ...
          <div className="bg-gradient-to-b h-fi from-[#cbeef3] to-[#c4f1f7] w-[100%] justify-center flex flex-col   rounded-2xl p-6">
            <div className="flex items-center flex-col space-x-4 p-10">
              <div className="p-3 bg-[url(../public/srs.jpg)] max-md:size-61 bg-center bg-contain bg-no size-81 rounded-3xl ">
          ...
          <div className="bg-gradient-to-br w-[100%] justify-center flex flex-col from-[#b2d6f1] to-[#cbd8e2]  rounded-2xl p-6">
            <div className="flex items-center justify-center flex-col space-x-4 p-10">
              <div className=" bg-[url(../public/goal.png)] max-md:size-61 size-82 bg-cover bg-no-repeat bg-center   ">
               
              </div>
            </div>
            <div className=" mt-4 text-2xl font-medium  pb-3 text-shadow-gray-900 text-input ">Set Custome Goal</div>
            <p className="w-[50%]">Define your goal. Stay on track. Achieve it your way</p>
          </div>
      ...
      <div className="max-w-6xl bg-white p-5 rounded-2xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="bg-primary flex justify-between items-center w-[100%] max-md:w-[100vw] contaier p-10  ">
          <div className="">

          <p className="text-[2.5rem] max-md:text-[1.2rem] font-medium text-white">Backed by Science, Built for Revision.</p>
          </div>
          <div>
